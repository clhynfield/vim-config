...
(Re)move ~/.vim and ~/.vimrc if you have them already, and run:
    ...
    git clone https://github.com/clhynfield/vim-config.git ~/.vim
...
* [Limelight](https://github.com/junegunn/limelight.vim) Hyperfocus-writing in Vim. Current paragraph maintains normal color while other paragraphs dim to a lowkey grey.
